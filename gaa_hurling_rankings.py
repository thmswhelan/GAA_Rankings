# Calculate GAA Hurling Rankings
import pandas as pd
import numpy as np
import re
...
valid_comps = ["Allianz Hurling League Roinn 1",
...
# Initialize ratings from the second column of gaa_hurling_rankings_pivot.xlsx
ratings = {}

pivot_file = "gaa_hurling_rankings_pivot.xlsx"
...
output_file = "gaa_hurling_rankings_pivot.xlsx"
...
print("Pivoted rankings saved to gaa_hurling_rankings_pivot.xlsx")
